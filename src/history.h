...
#define PawnEntry(move)         (&thread->pawnHistory[thread->pos.pawnKey % 512][piece(move)][toSq(move)])
...
#define PawnHistoryUpdate(move, bonus)         (HistoryBonus(PawnEntry(move),         bonus, 16384))
