...
static void SetOption(char *str) {
    ...
    else if (OptionNameIs("HistMCDiv"    )) HistMCDiv  = IntValue;
    else if (OptionNameIs("HistCCDiv"    )) HistMCDiv  = IntValue;
    ...
    else if (OptionNameIs("HistGetPCDiv" )) HistGetPCDiv = IntValue;
    else if (OptionNameIs("HistGetMCDiv" )) HistGetMCDiv = IntValue;
    else if (OptionNameIs("HistGetCC2Div")) HistGetCC2Div = IntValue;
    else if (OptionNameIs("HistGetCC3Div")) HistGetCC3Div = IntValue;
    else if (OptionNameIs("HistGetCC4Div")) HistGetCC4Div = IntValue;
...
static void Info() {
    ...
    printf("option name HistMCDiv type spin default %d min %d max %d\n", HistMCDiv, -100000, 100000);
    ...
    printf("option name HistGetPCDiv type spin default %d min %d max %d\n", HistGetPCDiv, -100000, 100000);
    printf("option name HistGetMCDiv type spin default %d min %d max %d\n", HistGetMCDiv, -100000, 100000);
