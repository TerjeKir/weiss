...
static void InitPSQT() {
	...
	const int tempPSQT[7][64] = {
		...
		S( 5,  5), S( 0,  0), S( 0,  0), S(  5,   5), S(  5,   5), S( 0,  0), S( 0,  0), S( 5,  5),
		S(10, 10), S(10, 10), S( 0,  0), S(-10, -10), S(-10, -10), S( 0,  0), S(10, 10), S(10, 10),
		S( 0,  0), S( 0,  0), S( 0,  0), S(  0,   0), S(  0,   0), S( 0,  0), S( 0,  0), S( 0,  0)},
		...
		S(5, 5), S( 10,  10), S(15, 15), S(20, 20), S(20, 20), S(15, 15), S( 10,  10), S(5, 5),
		S(0, 0), S(  0,   0), S(10, 10), S(20, 20), S(20, 20), S(10, 10), S(  5,   5), S(0, 0),
		S(0, 0), S(  0,   0), S(10, 10), S(10, 10), S(10, 10), S(10, 10), S(  0,   0), S(0, 0),
		S(0, 0), S(  0,   0), S( 0,  0), S( 5,  5), S( 5,  5), S( 0,  0), S(  0,   0), S(0, 0),
		S(0, 0), S(-10, -10), S( 0,  0), S( 0,  0), S( 0,  0), S( 0,  0), S(-10, -10), S(0, 0)},
    	...
    	S(  0, -50), S(  5, -10), S(  5,  0), S(-10,  0), S(-10,  0), S(  0,  0), S( 10, -10), S(  5, -50)}};
